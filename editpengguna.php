	    	...
	    	<div class="sidebar-wrapper">				
	            <ul class="nav">
					...
					<li class="active">
						...
						<div class="collapse in" id="settingsOverview">
							<ul class="nav">
								<li class="active">
									<a href="pengguna.php">
...
<?php 
		...
		$password = '';
		include 'koneksi.php';
		$data = mysqli_query($koneksi,"select * from data_pengguna WHERE username = '" .$id . "'");
		if($data)
		{
...
?>
							    <form method="post" enctype="multipart/form-data" action="proses/addpengguna.php">
		                            ...
		                            <div class="card-content">
                                    	<div class="form-group">
	                                        <input type="hidden" readonly placeholder="id" name = "id" class="form-control" value="<?php echo $id; ?>">
	                                    </div>
	                                    <div class="form-group">
