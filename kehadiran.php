	                            ...
	                            <div class="card-content">
	                                ...
	                                <table id="bootstrap-table" class="table">
	                                    <thead style="background-color:rgb(255, 239, 191);"> 
                                             ...
                                             <th class = "text-right" data-field="jumlahhari"  data-sortable="true">Jumlah Hari</th>
                                             <th class = "text-right" data-field="jumlahhadir" data-sortable="true">Jumlah Hadir</th>
