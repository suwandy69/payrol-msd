...
<?php 
		...
		$nama = '';
		include 'koneksi.php';
		$data = mysqli_query($koneksi,"select * from data_jabatan WHERE id_jabatan = '" .$id ."'");
		if($data)
		{
...
?>
							    <form method="post" enctype="multipart/form-data" action="proses/addjabatan.php">
		                            ...
		                            <div class="card-content">
                                    	...
                                    	<div class="form-group">
	                                        ...
	                                        <input type="text" placeholder="id" name = "id_jabatan" class="form-control" value="<?php echo $id; ?>">
	                                    </div>
	                                    <div class="form-group">
