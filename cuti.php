	                            ...
	                            <div class="card-content">
	                                ...
	                                <table id="bootstrap-table" class="table">
	                                    <thead style="background-color:rgb(255, 239, 191);"> 
                                             ...
                                             <th class = "text-right" data-field="jumlah_cuti" data-sortable="true">jumlah_cuti</th>
	                                    </thead>
	                                    <tbody>
<?php 
		include 'koneksi.php';
		$no=0;
		$data = mysqli_query($koneksi,"SELECT data_cuti.id_cuti, data_pegawai.npp, data_pegawai.nama, data_cuti.jumlah_cuti FROM data_cuti INNER JOIN data_pegawai ON data_cuti.npp = data_pegawai.npp");
...
?>
                                            ...
                                            >
                                                ...
                                                <td class = "text-right"><?php echo number_format($d['jumlah_cuti']); ?></td>
	                                        </tr>
<?php 
		}
?>
