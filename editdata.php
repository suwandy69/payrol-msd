...
?>
							    <form method="post" enctype="multipart/form-data" action="proses/adddata2.php">
		                            ...
		                            <div class="card-content">
	                                    ...
	                                    <div class="form-group">
	                                        <label>Lembur</label>
	                                        <input type="text" placeholder="lembur" name="lembur" class="form-control" value="<?php echo $lembur; ?>">
	                                    </div>
	                                    <div class="form-group">
	                                        <label>Tanggal Merah</label>
	                                        <input type="text" placeholder="tanggal_merah" name="tanggal_merah" class="form-control" value="<?php echo $tanggal_merah; ?>">
	                                    </div>
	                                    <div class="form-group">
	                                        <label>Hari Raya</label>
	                                        <input type="text" placeholder="hari_raya" name="hari_raya" class="form-control" value="<?php echo $hari_raya; ?>">
	                                    </div>
	                                    <div class="form-group">
	                                        <label>On Call</label>
	                                        <input type="text" placeholder="on_call" name="on_call" class="form-control" value="<?php echo $on_call; ?>">
	                                    </div>
	                                    <div class="form-group">
	                                        <label>Rujuk</label>
	                                        <input type="text" placeholder="rujuk" name="rujuk" class="form-control" value="<?php echo $rujuk; ?>">
	                                    </div>
	                                    <div class="form-group">
	                                        <label>Rekom Sip</label>
	                                        <input type="text" placeholder="rekom_sip" name="rekom_sip" class="form-control" value="<?php echo $rekom_sip; ?>">
	                                    </div>
	                                    <div class="form-group">
	                                        <label>Jasmed</label>
	                                        <input type="text" placeholder="jasmed" name="jasmed" class="form-control" value="<?php echo $jasmed; ?>">
	                                    </div>
	                                    <!--<div class="form-group">
