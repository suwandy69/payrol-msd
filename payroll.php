	                            ...
	                            <div class="card-content">
	                                ...
	                                <table id="bootstrap-table" class="table">
	                                    <thead style="background-color:rgb(255, 239, 191);">                          
                                             ...
                                             <th class = "text-right" data-field="Struktural"  data-sortable="true">Tunjangan</th>
                                             ...
                                             <th class = "text-right" data-field="Fungsional"  data-sortable="true">Koor</th>
...
?>
											...
											?>>
												...
												?></td>
                                                <td class = "text-right" ><?php echo number_format(nilaigaji($d['pendidikan'],$selisih,$d['golongan'])); ?></td>  
                                                ...
                                                <td class = "text-right"><?php echo number_format(nilaitakehome(nilaigaji($d['pendidikan'],$selisih,$d['golongan']), $d['Struktural'], $d['lembur'], $d['tanggal_merah'], 
												$d['hari_raya'], $d['Fungsional'], 
												$d['on_call'], $d['rujuk'], $d['rekom_sip'], $d['jasmed'], $d['lainlain'], $d['BPJSNaker'], $d['BPJSKes'], 
												$d['obat'], $d['pinjaman'], $d['izin'], $d['keterlambatan'], $d['lain2'] )); ?></td> 
	                                        </tr>
<?php 
		}
?>
