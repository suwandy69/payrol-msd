	                            ...
	                            <div class="card-content">
	                                ...
	                                <table id="bootstrap-table" class="table">
	                                    <thead style="background-color:rgb(255, 239, 191);"> 
                                            ...
                                            <th class = "text-right" data-field="BPJSNaker"  data-sortable="true">BPJS Tenaga Kerja</th>
                                            <th class = "text-right" data-field="BPJSKes" data-sortable="true">BPJS Kesehatan</th>
	                                    </thead>
	                                    <tbody>
<?php 
		include 'koneksi.php';
