...
<?php 
		...
		$nama = '';
		include 'koneksi.php';
		$data = mysqli_query($koneksi,"select * from data_golongan WHERE id_golongan = '" .$id ."'");
		if($data)
		{
		while($d = mysqli_fetch_array($data)){	
		$id = $d['id_golongan'];
		$nama = $d['nama_golongan'];
		}
		}
?>
							    <form method="post" enctype="multipart/form-data" action="proses/addgolongan.php">
		                            ...
		                            <div class="card-content">
                                    	<div class="form-group">
	                                        <input type="hidden" placeholder="id" name = "id" class="form-control" value="<?php echo $id; ?>">
	                                    </div>
                                    	<div class="form-group">
	                                        <label>ID Status</label>
	                                        <input type="text" placeholder="id" name = "id_golongan" class="form-control" value="<?php echo $id; ?>">
	                                    </div>
	                                    <div class="form-group">
