...
?>
	            ...
	            <div class="card card-lock">
	            	 <button  onclick="location.href='editkaryawan.php'" type="button" class="btn btn-wd">Tambah Karyawan</button>
	            	 <!--<button  onclick="location.href='uploadkaryawan.php'" type="button" class="btn btn-wd">Upload Excel Karyawan</button>-->
	            </div>
	        </div>
            <footer class="footer">
                <div class="container-fluid">
...
//	                    console.log(info);
						info = JSON.stringify(row['id']).replaceAll('"','');
						window.open("editkaryawan.php?id=" + info,"_self");
	                },
